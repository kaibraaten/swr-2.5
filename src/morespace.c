...
static void create_transport1_rooms( SHIP_DATA *s, ROOM_INDEX_DATA *room[] );
static void create_transport2_rooms( SHIP_DATA *s, ROOM_INDEX_DATA *room[] );
...
static void create_battleship_rooms( SHIP_DATA *s, ROOM_INDEX_DATA *room[] );
